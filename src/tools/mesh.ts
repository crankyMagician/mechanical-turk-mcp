...
export function registerMeshTools(ctx: ToolContext): ToolRegistration {
  const tools = [
    {
  ...
  const handlers: Record<string, (args: any) => Promise<any>> = {
    export_mesh_library: async (rawArgs: any) => {
      ...
      try {
        ...
        const params: any = { scenePath: args.scenePath, outputPath: args.outputPath };

...
export function isValidGodotPathSync(path) {
    try {
...
export async function isValidGodotPath(path) {
...
export async function detectGodotPath(currentPath, strictPathValidation) {

    ...
    const handlers = {
        ...
        add_node: async (rawArgs) => {
            ...
            try {
                ...
                const params = { scenePath: args.scenePath, nodeType: args.nodeType, nodeName: args.nodeName };
